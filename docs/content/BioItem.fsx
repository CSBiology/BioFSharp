...
//We create a modification at the residual called phosphorylation
let phosphorylation = ModificationInfo.createModification "Phosphorylation" ModificationInfo.ModLocation.Residual phosporylate
