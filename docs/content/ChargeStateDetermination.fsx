...
let peakWindowParamTest =
    ChargeState.createPeakWindowParams 1.1 0.15 0.3
...
let rnd = MathNet.Numerics.Random.MersenneTwister() 
...
let determinedCharge = 
    ///
    let spectralCentroidsInWindow = 
        PeakDetection.centroidedPeaksInWindowBy rawMZData rawIntensityData 3. ms2PrecursorMZ  
    ///
    let putchargeList = 
        ChargeState.putativePrecursorChargeStatesBy chargeDetParamTest spectralCentroidsInWindow ms2PrecursorMZ
    ///
    let testedItems = 
        putchargeList 
