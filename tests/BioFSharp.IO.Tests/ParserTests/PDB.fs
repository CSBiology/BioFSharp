...
let atomSequence = Helpers.readEmbeddedDocument "ATOMSequence.txt"

let hetatmSingleton = """HETATM 1109  CAD HEM A   1       7.618   5.696 -20.432  6.00 21.38           C  """

let hetatmSequence = Helpers.readEmbeddedDocument "HETATMSequence.txt"

let terSingleton = """TER    1070      ARG A 141""".PadRight(80, ' ')

let glucagon = Helpers.readEmbeddedDocument "Glucagon.txt"
    
let HasA = Helpers.readEmbeddedDocument "HasA.txt"
