...
[<assembly: AssemblyVersionAttribute("1.0.03")>]
[<assembly: AssemblyFileVersionAttribute("1.0.03")>]
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "1.0.03"
    let [<Literal>] AssemblyFileVersion = "1.0.03"
